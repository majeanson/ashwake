...
import { markGroup } from '../packages/core/src/meta/mark';
import { THEMES } from '../packages/core/src/theme/index';
import { hex, isLight, rgba, type Theme } from '../packages/core/src/theme/tokens';
...
const at = (p: string): string =>
  fileURLToPath(new URL(`../apps/game/public/${p}`, import.meta.url));
