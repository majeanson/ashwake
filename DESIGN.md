<!-- Carried over WHOLE from ../tiles/DESIGN.md on 2026-08-28: the rules of Ashwake 2
are the same code (DECISIONS.md D2, proved by the golden sim diff), so their design
record is the same document. Session numbers and file paths inside refer to
Ashwake 1. Edit here only when a rule moves — and then the golden file moves too. -->
